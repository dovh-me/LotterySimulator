...
var checkNumsButton = document.getElementById("validateBtn");

checkNumsButton.addEventListener("click", () =>{
    var inputNum = [];
    for(var i = 1; i < 7; i++) {
        var elementName = "num1" + i;
        inputNum.push(document.getElementById(elementName)); 
    }
});
